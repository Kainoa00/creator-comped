...
export function InternalAdminLayout() {
  ...
  const navItems = [
    { to: "/internal-admin", icon: Users, label: "Applications", end: true },
    { to: "/internal-admin/submissions", icon: FileCheck, label: "Submissions" },
    { to: "/internal-admin/support", icon: HelpCircle, label: "Support" },
  ];
