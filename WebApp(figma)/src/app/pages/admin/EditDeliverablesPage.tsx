...
export function EditDeliverablesPage() {
  const [formData, setFormData] = useState({
    ...
    tagRestaurant: true,
    postingDeadline: "48 hours", // Fixed
    avoidTopics: "Politics, religion, controversial topics", // Fixed
    usageRights: true,
    usageRightsText: "By participating, creators grant the restaurant rights to repost content on their official channels.",
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-white/70">Require creators to post on Instagram feed</p>
              </div>
              <label className="relative inline-block w-12 h-6">
                <input
                  type="checkbox"
                  checked={formData.instagramRequired}
                  onChange={(e) => handleChange("instagramRequired", e.target.checked)}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-white/70">Require creators to post on TikTok</p>
              </div>
              <label className="relative inline-block w-12 h-6">
                <input
                  type="checkbox"
                  checked={formData.tiktokRequired}
                  onChange={(e) => handleChange("tiktokRequired", e.target.checked)}
                  className="sr-only peer"
                />
                <div className="w-12 h-6 bg-white/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-orange-500 peer-checked:to-blue-600"></div>
              </label>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-white/70">Optional Instagram story requirement</p>
              </div>
              <label className="relative inline-block w-12 h-6">
                <input
                  type="checkbox"
                  checked={formData.instagramStory}
                  onChange={(e) => handleChange("instagramStory", e.target.checked)}
                  className="sr-only peer"
                />
                <div className="w-12 h-6 bg-white/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-orange-500 peer-checked:to-blue-600"></div>
              </label>
