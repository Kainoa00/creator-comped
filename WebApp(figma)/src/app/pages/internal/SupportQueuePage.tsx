...
const mockTickets: SupportTicket[] = [
  {
    ...
    message: "Hi, I tried to redeem my comp at Italian Place yesterday but the QR code wouldn't scan. The restaurant staff tried multiple times but it kept showing an error. Can you help? My comp ID is #12345.",
  ...
  },
  {
    ...
    message: "We need to update our menu but some items aren't appearing in the dashboard. When I try to add new items to the Pizza category, I get an error. Could you please look into this?",
  ...
  },
  {
    ...
    message: "Hi! I was ranked #3 last month but haven't received my prize payment yet. Can you check on the status? Thanks!",
  ...
  },
  {
    ...
    message: "I own a restaurant and I'm interested in joining Creator Comped. What are the requirements and how do I get started? Do you have any pricing information?",
          ...
          {filteredTickets.map((ticket) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                {ticket.status === "open" && (
                  <div className="px-2 py-0.5 rounded-full bg-orange-500/20 text-orange-500 text-xs">
                    Open
                  </div>
                )}
                ...
                <div className="bg-green-500/10 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-white/70">This support ticket has been marked as resolved.</div>
                    </div>
                  </div>
                </div>
              )}
