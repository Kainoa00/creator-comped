  ...
  return (
    <div className="px-8 py-6 space-y-6">
      ...
      <div className="grid grid-cols-3 lg:grid-cols-6 gap-4">
        {STATS.map((stat) => (
          <div key={stat.label} className="border border-slate-200 rounded-lg p-4">
      ...
      <div className="grid grid-cols-12 gap-5">
        {/* Proof Review */}
        <div className="col-span-7 border border-slate-200 rounded-lg">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200">
            <div className="flex items-center gap-2">
              <h2 className="text-sm font-semibold text-slate-900">Pending Proof Review</h2>
              {pendingProofs.length > 0 && (
                <span className="text-xs text-slate-400 font-medium">({pendingProofs.length})</span>
              )}
            </div>
          ...
          {pendingProofs.length === 0 ? (
            <div className="flex flex-col items-center py-12 text-center">
              ...
              <p className="text-xs text-slate-400 mt-0.5">No proofs pending review.</p>
            </div>
          ) : (
            <ul>
        ...
        <div className="col-span-5 border border-slate-200 rounded-lg">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200">
            <div className="flex items-center gap-2">
              <h2 className="text-sm font-semibold text-slate-900">Pending Vetting</h2>
              <span className="text-xs text-slate-400 font-medium">({PENDING_CREATORS.length})</span>
            </div>
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-5 border border-slate-200 rounded-lg">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200">
            <div>
              <h2 className="text-sm font-semibold text-slate-900">February Leaderboard</h2>
              <p className="text-xs text-slate-400 mt-0.5">Feb 2026 · 2 days remaining</p>
            </div>
          ...
          <div className="px-5 py-4 space-y-5">
            <div>
              <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mb-3">IG Reel</p>
