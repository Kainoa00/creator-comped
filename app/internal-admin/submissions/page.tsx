        ...
        <div className="flex-1 overflow-y-auto">
          {filteredSubmissions.map((sub) => (
            ...
            >
              ...
              <div className="text-sm text-white/70 mb-1">Restaurant: {sub.restaurant}</div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex items-start justify-between mb-8">
                <div>
                  ...
                  <p className="text-sm text-white/50 mt-1">Restaurant: {selectedSubmission.restaurant}</p>
                </div>
