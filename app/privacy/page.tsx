...
export const metadata: Metadata = {
  title: 'Privacy Policy — CreatorComped',
}
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            We use your information to operate the CreatorComped platform, verify your identity as a creator,
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            By participating in CreatorComped, you grant partner restaurants a non-exclusive, royalty-free
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            ...
            partners are prohibited from using your information for purposes outside the CreatorComped program.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            ...
            is active. You may request deletion of your account by contacting support@creatorcomped.com.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            The CreatorComped app requests camera access solely to scan QR codes at partner restaurants
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            CreatorComped is not directed at children under the age of 13. We do not knowingly collect
