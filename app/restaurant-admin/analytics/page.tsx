...
export default function AnalyticsPage() {
  ...
  const totalMetrics = topCreators.reduce(
    (acc, creator) => {
              ...
              {topCreators.map((creator) => {
                ...
                return (
                  <tr key={creator.rank} className="hover:bg-white/5 transition">
                    ...
                    <td className="py-4 px-4">
                      <div className="font-semibold">{(platformData.views / 1000).toFixed(0)}K</div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="font-semibold">{(platformData.likes / 1000).toFixed(1)}K</div>
                    </td>
                    <td className="py-4 px-4">
