  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Link
          href="/restaurant-admin/deliverables"
          className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/5 hover:bg-white/10 transition group"
        >
          <div className="flex items-start justify-between mb-4">
            <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/5">
            ...
            <div className="mb-3">
              ...
              <div className="text-sm text-white/70">$108 remaining this month</div>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/5">
            ...
            <div className="mb-3">
              ...
              <div className="text-sm text-white/70">Chain-wide setting</div>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/5">
            ...
            <div className="mb-3">
              ...
              <div className="text-sm text-white/70">Maximum per comp</div>
            </div>
            <button className="text-sm text-orange-500 hover:text-orange-400 transition">
              Adjust item limit →
            </button>
