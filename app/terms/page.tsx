      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            By creating an account on HIVE, you agree to these Terms of Service. If you do not
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            HIVE is an invite-only platform. Creators must be approved through our vetting process
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            The following content is strictly prohibited in posts made through HIVE: political
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            We may update these terms at any time. Continued use of HIVE after changes constitutes
