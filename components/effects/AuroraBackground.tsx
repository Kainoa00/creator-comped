...
export function AuroraBackground({ className }: AuroraBackgroundProps) {
  return (
    ...
    >
      <div
        className="aurora-blob absolute rounded-full blur-[100px] opacity-[0.07]"
        style={{
          width: 500,
          height: 500,
      ...
      />
      <div
        className="aurora-blob absolute rounded-full blur-[100px] opacity-[0.05]"
        style={{
          width: 400,
          height: 400,
      ...
      />
      <div
        className="aurora-blob absolute rounded-full blur-[80px] opacity-[0.04]"
        style={{
          width: 300,
          height: 300,
