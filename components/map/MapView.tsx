...
interface MapViewProps {
  ...
  /** Base path for restaurant detail navigation (default: /creator/discover) */
  basePath?: string
}
...
export function MapView({ restaurants, basePath = '/creator/discover' }: MapViewProps) {
  ...
  const handleViewMenu = useCallback(
    (restaurantId: string) => {
      router.push(`${basePath}/${restaurantId}`)
    },
    [router, basePath]
  )
